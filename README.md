...
## Capturas
- ![lista](appPueblosJaenIos/appPueblosJaen/appPueblosJaen/Docs/Images/lista.png)
- ![detalle](appPueblosJaenIos/appPueblosJaen/appPueblosJaen/Docs/Images/detalle.png)
- ![fotos](appPueblosJaenIos/appPueblosJaen/appPueblosJaen/Docs/Images/fotos.png)
...
- Test unitarios de los componentes de red para asergurar su funcionamiento.
- Código moderno en Swift con concurrencia (async/await) y tipado seguro (Codable).
- Navegación por caja de estados, para controlar mejor la navegación por la app y los errores que surgan.
